<div class="productsFeatures index">
	<h2><?php echo __('Products Features'); ?></h2>
	...
	<tbody>
	<?php foreach ($productsFeatures as $productsFeature): ?>
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $productsFeature['ProductsFeature']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $productsFeature['ProductsFeature']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $productsFeature['ProductsFeature']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $productsFeature['ProductsFeature']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
