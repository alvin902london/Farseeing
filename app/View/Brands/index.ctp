<div class="brands index">
	...
	<tr>
		...
		<td><?php echo h($brand['Brand']['remarks']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $brand['Brand']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $brand['Brand']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
