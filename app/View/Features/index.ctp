<div class="features index">
	...
	<tr>
		...
		<td><?php echo h($feature['Feature']['remarks']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $feature['Feature']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $feature['Feature']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
